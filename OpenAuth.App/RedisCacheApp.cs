...
namespace OpenAuth.App
{
    ...
    public class RedisCacheApp
    {
        ...
        public RedisCacheApp(IDistributedCache distributedCache)
        {
        ...
        {
            byte[] val = null; if (value.ToString() != "")
            {
        ...
        {
            string ReturnString = null; var value = await _cache.GetAsync(key); if (value != null)
            {
